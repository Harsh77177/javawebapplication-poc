...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Harsh Sinha</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#contact">Contact
							Us</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xl-7">
					...
					<form method="post" action="contact" id="contactForm">
						...
						<!-- data-sb-form-api-token="5e9269f6-e425-44ab-99cd-11af0ecd4ab7" -->
						<!-- "API_TOKEN"> --				
	...
	<script type="text/javascript">
		...
		if (status == "success") {
			swal("cool", "Response Noted! Thanks", "success");
		}
	</script>
	<!-- Footer-->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<p class="lead mb-0">
						Freelance is a free to use, Bootstrap theme created
